...
for i = 1:m
    if isempty(find(order==i, 1)) == 1
       [RD,CD,order,k,RD1,OP]=ExpandClusterOrder(D,eps,minpts,OP,RD,CD,order,RD1,i,k,seeds);                
    end
end
end

function [RD,CD,order,k,RD1,OP] = ExpandClusterOrder(D,eps,minpts,OP,RD,CD,order,RD1,i,k,seeds)
